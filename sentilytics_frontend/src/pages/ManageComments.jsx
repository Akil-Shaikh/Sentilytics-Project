...
return (
    <div className="dashboard-container">
        ...
        <div className="tab-content">
            ...
            <button className="btn-pages" onClick={toggleEditMode}>{editMode ? "Exit Edit Mode" : "Enable Edit Mode"}</button>
            ...
            {loading ? (
                <div class="text-center loading-align">
                    <div role="status">
                        <svg aria-hidden="true" class="spinner inline w-30 h-30 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
